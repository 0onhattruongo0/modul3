    ...
    <form class="d-flex" action="{{route('nhanvien.addform')}}" method="post">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="manhanvien" id="exampleInputMaNv"  placeholder="Nhap MaNhanVien">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="hoten" id="exampleInputName"  placeholder="Nhập Họ Tên">
            </div>
            <div class="form-group">
                <label for="exampleInputdate">Ngày sinh</label>
                <input type="date" class="form-control" name="ngaysinh" id="exampleInputdate" >
            </div>
            <div class="form-group">
        ...
        <div class="col-6">
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="sodienthoai" id="exampleInputSdt"  placeholder="Nhập Số điện thoại">
            </div>
            <div class="form-group">
                <label for="exampleInputCMND">Số CMND</label>
                <input type="number" class="form-control" name="cmnd" id="exampleInputCMND"  placeholder="Nhập Số CMND">
            </div>
            <div class="form-group">
                <label for="exampleInputEmail">Email</label>
                <input type="text" class="form-control" name="email" id="exampleInputEmail"  placeholder="Nhập Email">
            </div>
            <div class="form-group">
                <label for="exampleInputdiachi">Địa chỉ</label>
                <textarea type="text" name="diachi"></textarea>
            </div>
